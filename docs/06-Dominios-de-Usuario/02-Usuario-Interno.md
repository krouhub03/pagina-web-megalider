...
| `/contabilidad/auditoria` | `app/(admin)/contabilidad/auditoria/page.tsx` | **Bandeja de Auditoría Hermes IA (PostgreSQL):** Revisión y corrección de facturas procesadas automáticamente por la inteligencia artificial. |
